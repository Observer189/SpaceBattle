...
public class LaserAmmo extends PhysicAmmo {
    ...
    public LaserAmmo(TextureAtlas textureAtlas, float x, float y,float startAngle, float width, float height, float speed, Vector2 shipSpeedVector, float damage, World world) {
        super(textureAtlas.findRegion("BlueLaserAmmo"), x, y, width, height, 1, 1, new float[][]{{
                    -width/2,-height/2,
                    width/2,-height/2,
                    width/2,height/2,
