...
public class PhysicObject {
    ...
    private int fixturesNumber;

    PhysicObject(String spriteName, float x, float y, float rotation, float width, float height, float density, int fixturesNumber, float[][] shape) {
        this.x = x;
        this.y = y;
