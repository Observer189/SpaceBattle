...
public class Angar implements Screen {
    ...
    OldPlayer oldPlayer;
    private DrawOneShip dos1, dos2, dos3, dos4, dos5, dos6, dos7, dos8, dos9;

    //  DrawStageForGuns DSFG;
    private Button.ButtonStyle BaStyle;
    private StageForButton Back;
    int counter = 1;
    int counterg = 1;
    private StationAnim station1;
...
//        DrawDrawStage(dos1);
    ...
    class DrawOneShip extends Stage {
        ...
        DrawOneShip(String name, float x, float y) {
            if (name.equals("1")) name = "Pulsate";
