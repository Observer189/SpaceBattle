...
public class Battle implements Screen {
    ...
    public void render(float delta) {
        ...
        if(player.getCurrentShip().getCenterX()+widthCamera/2>=classicMap.getWidth())
        {
            camera.position.x=classicMap.getWidth()-widthCamera/2;
        }
        else if(player.getCurrentShip().getCenterX()-widthCamera/2<=0)
        {
        ...
        if(player.getCurrentShip().getCenterY()+heightCamera/2>=classicMap.getHeight())
        {
            camera.position.y=classicMap.getHeight()-heightCamera/2;
        }
        else if(player.getCurrentShip().getCenterY()-heightCamera/2<=0)
        {
