...
public class ShopList2 implements Screen {
    Game game;
    private Button.ButtonStyle Gstyle, Sstyle, BaStyle;
    private StageForButton Guns, Ships, Back;
    SpriteBatch batch;
    ...
    OldPlayer oldPlayer;
    private CellStage g1, g2, g3, g4;
    private Image Money, InformationTube;
    private BitmapFont font, font1;
    private int counter = 0;
    private Boolean NeedToMove = false;
    private Boolean NeedToMoveBack = false;
    private StageForButton Prev, Go;
    private Button.ButtonStyle Gostyle, Prevstyle;
    // Weapon laser,multi;
    private BlueImpulseLaser Laser;
    private Machinegun multigun;
    ...
    private GunShow GuShow;
    OrthographicCamera camera = new OrthographicCamera();

    ShopList2(Game game, SpriteBatch batch, TextureAtlas textureAtlas, MainMenu menu, OldPlayer oldPlayer) {
        this.game = game;
        this.batch = batch;
    ...
    class CellStage extends Stage {
        ...
        CellStage(int x, int y, String name, int price, float width, float height) {
            this.x = x;
            this.y = y;
            this.name = name;
